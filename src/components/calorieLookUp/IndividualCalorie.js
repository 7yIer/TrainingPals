        ...
        return (
            <div className='calorie-item-container' key={this.props.calories + this.props.protein}>
                ...
                <div className='calorie-increment-decrement-wrapper'>
                    <label className='calorie-increment-serving' htmlFor={incrementId}><img style={{cursor: 'pointer'}} className='calorie-look-up-increment-image' src="https://img.icons8.com/windows/512/add--v1.png"/></label>
                </div>

                <button id={decrementId} hidden={true} onClick={this.onDecrement}>-</button>
                <div className='calorie-increment-decrement-wrapper'>
                    <label className='calorie-decrement-serving' htmlFor={decrementId}><img style={{cursor: 'pointer'}} className='calorie-look-up-decrement-image' src="https://img.icons8.com/windows/512/minus-sign.png"/></label>
                </div>
                    ...
                    <label className='add-searched-calorie' htmlFor={addItemId}><img style={{cursor: 'pointer'}} className='calorie-look-up-add-image' src="https://img.icons8.com/windows/512/checked.png"/></label>
                </div>
            </div>
        )
    }
