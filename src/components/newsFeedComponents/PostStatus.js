                        ...
                        <div className='status-position'>
                            ...
                            <form id='postStatusForm' onSubmit={this.onSubmit}>
                                <div className='profile-form-wrapper'>
                                    ...
                                    <label className='profile-upload-photo-icon' htmlFor={id}><img className='profile-status-image-upload' src="https://img.icons8.com/windows/512/picture.png"/></label>
                                </div>
                            </form>
                        </div>
                ...
                <div>
                    <h2 className='dashboard-post-status-title'>Post a Status!</h2>
                        ...
                        <form id='postStatusForm' onSubmit={this.onSubmit}>
                                ...
                                <input id={id} type="file" accept="image/*" style={{display: 'none'}} onChange={this.handleFileUploadChange}/>
                                <label className='dashboard-upload-icon' htmlFor={id}><img style={{cursor: 'pointer'}} className='calorie-look-up-increment-image' src="https://img.icons8.com/windows/512/picture.png"/></label>
                        </form>
                </div>
