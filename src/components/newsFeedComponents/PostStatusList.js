                                ...
                                <div className='dashboard-status-list-container'>
                                    ...
                                    {status.createdBy === this.props.currentUser.id && 
                                        <div className='dashboard-remove-status-wrapper'> 
                                            ...
                                            <label className='dashboard-remove-status' htmlFor={removeId} style={{cursor: 'pointer'}}><img className='dashboard-status-remove-image' src="https://img.icons8.com/windows/512/cancel.png"/></label>
                                        </div>
                                        }
                                            ...
                                            <div>
                                                <div className='dashboard-image-remove-wrapper'>
                                                    <div className='dashboard=image-remove-container'>
                                                        ...
                                                        <label className='dashboard-image-remove' style={{cursor: 'pointer'}} htmlFor={removeId}><img className='dashboard-status-remove-image' src="https://img.icons8.com/windows/512/cancel.png" /></label>
                                                        </div>
                                                    }
