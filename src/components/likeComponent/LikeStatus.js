        ...
        if (window.location.href.split('/')[3] === 'profile') {
            return (
                <div>
                    ...
                    <label htmlFor={id}><div><div className='profile-status-like-icon'><img className='profile-status-like-image' style={{cursor: 'pointer'}} src="https://img.icons8.com/windows/512/thumb-up.png"/></div></div></label>
                </div>
            );
            ...
            return (
                <div className='dashboard-like-profile-container'>
                    ...
                    <label htmlFor={id}><div className='dashboard-like-label-wrapper'><div className='dashbboard-like-label-icon'><img className='profile-status-like-image dashboard-status-like-image' style={{cursor: 'pointer'}} src="https://img.icons8.com/windows/512/thumb-up.png"/></div></div></label>
                </div>
            )
        }
