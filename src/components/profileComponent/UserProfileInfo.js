                    ...
                    <div className='profile-cover-photo-button'>
                        ...
                        <form id='coverPhotoForm' hidden={this.state.isMouseInside}>
                            ...
                            <div className='upload-cover-photo-icon'>
                                <label htmlFor={coverPhotoId}><img style={{cursor: 'pointer'}} onMouseEnter={this.onMouseEnterCoverPhoto} onMouseLeave={this.onMouseLeaveCoverPhoto} className='profile-cover-photo-upload-image' src="https://img.icons8.com/windows/512/picture.png"/></label>
                            </div>
                        </form>
                    </div>
