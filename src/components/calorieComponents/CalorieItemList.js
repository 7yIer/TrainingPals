                    ...
                    <div className='calorie-item-container calorie-item-container__hover' key={calorie.id}>
                        <div className='calorie-item-wrapper'>
                            ...
                            <div className='remove-calorie-item-wrapper'>
                                <label className='remove-calorie-item' style={{cursor: 'pointer'}} htmlFor={id}><img className='calorie-item-remove-image' src="https://img.icons8.com/windows/512/cancel.png" /></label>
                            </div>
